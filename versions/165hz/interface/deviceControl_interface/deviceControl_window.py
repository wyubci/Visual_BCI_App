...
my_dll = ctypes.CDLL(os.path.join(_base_dir, "source", "device", "LinkMe.dll"))
...
class DeviceControlWindow(QWidget):
    ...
    def makeDataWithShape(self, data):
        ...
        if dataSize > 0:
            ...
            car_data_value = np.asarray(data_value, dtype=float).copy()
            ...
            if paramsController.current_window == 'home':
                ...
                self.signalSendSignal_car.emit(car_data_value)
