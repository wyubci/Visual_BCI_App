...
class SSVEPNet(nn.Module):
    ...
    def spatial_block(self, nChan, dropout_level):
        ...
        '''
        block = []
        block.append(Conv2dWithConstraint(in_channels=1, out_channels=nChan * 2, kernel_size=(nChan, 1), max_norm=1.0))
