...
class EEGSignalShowModule(QChartView):
    ...
    def __initChart__(self):
        self.chart = QChart()
        # Apply Dark Theme for Cyberpunk look
        self.chart.setTheme(QChart.ChartThemeDark)
        self.chart.setBackgroundVisible(False) # Transparent background to use Window background
        
        # Customize Title Font and Color (if needed, though ThemeDark handles most)
        title_font = QFont("Microsoft YaHei")
        title_font.setPixelSize(12)
        title_font.setBold(True)
        self.chart.setTitleFont(title_font)
        self.chart.setTitleBrush(QBrush(QColor("#00E5FF"))) # Neon Cyan Title
        ...
        # Determine background color based on QSS (or transparent)
        ...
        label_brush = QBrush(QColor("#888888"))
        self.axisX.setLabelsBrush(label_brush)
        self.axisY.setLabelsBrush(label_brush)
