...
for f in nb:
    ...
    trials.append(t)
    for i, cmd in enumerate(['qianjin','houtui','zuozhuan','tingzhi','youzhuan']):
...
freqs = [6.667, 7.5, 8.571, 10.0, 12.0]
cmds = ['前进','后退','左转','停止','右转']
